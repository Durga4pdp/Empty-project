...
########################################
#Environment
#Existing cluster or cluster  -- testing
#Compute configuration (advanced) - compute options  - capacity_provider_strategy - capacity_provider - base - weight

#Deployment configuration
#application type - service  - task_definition - family - revision - service_name - Servicetype - replicas - desrired
